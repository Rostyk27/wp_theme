...
class Css extends Factory {
    ...
    protected function dump( $filename, $media = 'all' ) {
        echo "<style>body{opacity:0}</style><link href='" . $this->cache->getUrl() . $filename . "' onload='if(this.media!=\"all\") this.media=\"all\"' media='none' rel='stylesheet' type='text/css' />";
        echo "<noscript><link href='" . $this->cache->getUrl() . $filename . "' media='all' rel='stylesheet' type='text/css' /></noscript>";
    }
}
