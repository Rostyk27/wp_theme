            ...
            <?php if (have_posts()) : $p = 0; while (have_posts()) : the_post(); ?>
                <?php if($p == 0 /*&& $paged == 1*/) { ?>
                    <div class="firstpost blogpost">
                        ...
                        <p><?php echo wp_trim_words(get_the_content(), 65, ''); ?><a href="<?php the_permalink(); ?>" class="more">Learn More ></a></p>
                    </div>
                <?php } else { ?>
                    <div class="blogpost">
                        ...
                        <time datetime="<?php echo get_the_date('F j, Y'); ?>"><?php echo get_the_date('F j, Y'); ?></time>
                        <h3><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
                        <p><?php echo wp_trim_words(get_the_content(), 45, ''); ?><a href="<?php the_permalink(); ?>" class="more">Learn More ></a></p>
                    </div>
                <?php } ?>
                <?php $p++; endwhile; ?>
            <?php endif; ?>
